...
CREATE TYPE public.user_diet_enum AS ENUM (
    '0',
    '1',
    '2',
    '3',
...
CREATE TABLE public.game (
    ...
    menus_filter character varying[] DEFAULT ARRAY[]::character varying[] NOT NULL
);
...
CREATE TABLE public."user" (
    ...
    diet public.user_diet_enum DEFAULT '0'::public.user_diet_enum NOT NULL,
    ...
    vegan boolean DEFAULT true NOT NULL,
